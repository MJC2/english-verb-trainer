const questions = [
  ...
  { tense:"Present Simple", topic:"finops", es:"Revisamos los costos de la nube todos los días.", en:"We review cloud costs every day.", enPh:"uí riviú cláud kosts évri déi.", verb:{base:"review",past:"reviewed",participle:"reviewed",meaning:"revisar",basePh:"riviú",pastPh:"riviúd",participlePh:"riviúd"} },
  { tense:"Present Continuous", topic:"finops", es:"Estamos investigando una anomalía de costos.", en:"We are investigating a cost anomaly.", enPh:"uí ar invéstigueiting a kost anómali.", verb:{base:"investigate",past:"investigated",participle:"investigated",meaning:"investigar",basePh:"invéstigueit",pastPh:"invéstigueitid",participlePh:"invéstigueitid"} },
  { tense:"Present Perfect", topic:"finops", es:"Hemos identificado una oportunidad de ahorro.", en:"We have identified a savings opportunity.", enPh:"uí jav aidéntifaid a séivings oportuníti.", verb:{base:"identify",past:"identified",participle:"identified",meaning:"identificar",basePh:"aidéntifai",pastPh:"aidéntifaid",participlePh:"aidéntifaid"} },
  { tense:"Present Perfect Continuous", topic:"finops", es:"Hemos estado monitoreando el patrón de gasto durante tres meses.", en:"We have been monitoring the spending pattern for three months.", enPh:"uí jav bin mónitoring de spénding pátern for zrí manths.", verb:{base:"monitor",past:"monitored",participle:"monitored",meaning:"monitorear",basePh:"mónitor",pastPh:"mónitord",participlePh:"mónitord"} },
  { tense:"Past Simple", topic:"finops", es:"El equipo encontró una variación significativa en el presupuesto.", en:"The team found a significant budget variance.", enPh:"de tím fáund a signífikant bádyet várians.", verb:{base:"find",past:"found",participle:"found",meaning:"encontrar",basePh:"fáind",pastPh:"fáund",participlePh:"fáund"} },
  { tense:"Past Continuous", topic:"finops", es:"Estábamos revisando los principales impulsores de costos.", en:"We were reviewing the main cost drivers.", enPh:"uí uer riviúing de méin kost dráivers.", verb:{base:"review",past:"reviewed",participle:"reviewed",meaning:"revisar",basePh:"riviú",pastPh:"riviúd",participlePh:"riviúd"} },
  { tense:"Past Perfect", topic:"finops", es:"Habíamos actualizado el pronóstico antes de la reunión.", en:"We had updated the forecast before the meeting.", enPh:"uí jad apdéitid de fórkast bifór de míting.", verb:{base:"update",past:"updated",participle:"updated",meaning:"actualizar",basePh:"apdéit",pastPh:"apdéitid",participlePh:"apdéitid"} },
  { tense:"Past Perfect Continuous", topic:"finops", es:"Habíamos estado analizando el gasto antes de detectar la anomalía.", en:"We had been analyzing the spending before detecting the anomaly.", enPh:"uí jad bin ánalaizing de spénding bifór ditékting di anómali.", verb:{base:"analyze",past:"analyzed",participle:"analyzed",meaning:"analizar",basePh:"ánalaiz",pastPh:"ánalaizd",participlePh:"ánalaizd"} },
  { tense:"Future Simple", topic:"finops", es:"Revisaremos la variación del presupuesto mañana.", en:"We will review the budget variance tomorrow.", enPh:"uí uil riviú de bádyet várians tumórou.", verb:{base:"review",past:"reviewed",participle:"reviewed",meaning:"revisar",basePh:"riviú",pastPh:"riviúd",participlePh:"riviúd"} },
  { tense:"Be Going To", topic:"finops", es:"Vamos a mejorar la atribución de costos.", en:"We are going to improve cost attribution.", enPh:"uí ar góuing tu imprúv kost atribiúshon.", verb:{base:"improve",past:"improved",participle:"improved",meaning:"mejorar",basePh:"imprúv",pastPh:"imprúvd",participlePh:"imprúvd"} },
  { tense:"Future Continuous", topic:"finops", es:"Estaremos monitoreando esta tendencia durante los próximos meses.", en:"We will be monitoring this trend over the next few months.", enPh:"uí uil bi mónitoring dis trend óuver de nekst fiú manths.", verb:{base:"monitor",past:"monitored",participle:"monitored",meaning:"monitorear",basePh:"mónitor",pastPh:"mónitord",participlePh:"mónitord"} },
  { tense:"Future Perfect", topic:"finops", es:"Habremos actualizado el pronóstico para el viernes.", en:"We will have updated the forecast by Friday.", enPh:"uí uil jav apdéitid de fórkast bai fráidei.", verb:{base:"update",past:"updated",participle:"updated",meaning:"actualizar",basePh:"apdéit",pastPh:"apdéitid",participlePh:"apdéitid"} },
  { tense:"Future Perfect Continuous", topic:"finops", es:"Para fin de mes, habremos estado monitoreando el gasto durante tres meses.", en:"By the end of the month, we will have been monitoring spending for three months.", enPh:"bai di end ov de manth, uí uil jav bin mónitoring spénding for zrí manths.", verb:{base:"monitor",past:"monitored",participle:"monitored",meaning:"monitorear",basePh:"mónitor",pastPh:"mónitord",participlePh:"mónitord"} },,

  { tense:"Present Simple", topic:"prep", es:"Trabajo con el equipo de FinOps en la nube.", en:"I work with the FinOps team in the cloud.", enPh:"ai uérk uiz de fínops tím in de cláud.", verb:{base:"work",past:"worked",participle:"worked",meaning:"trabajar",basePh:"uérk",pastPh:"uérkt",participlePh:"uérkt"} },
  { tense:"Present Continuous", topic:"prep", es:"Estamos trabajando en el forecast con el equipo financiero.", en:"We are working on the forecast with the finance team.", enPh:"uí ar uérking on de fórkast uiz de fáinans tím.", verb:{base:"work",past:"worked",participle:"worked",meaning:"trabajar",basePh:"uérk",pastPh:"uérkt",participlePh:"uérkt"} },
  { tense:"Present Perfect", topic:"prep", es:"Hemos trabajado en esta optimización desde junio.", en:"We have worked on this optimization since June.", enPh:"uí jav uérkt on dis optimizéishon sins yun.", verb:{base:"work",past:"worked",participle:"worked",meaning:"trabajar",basePh:"uérk",pastPh:"uérkt",participlePh:"uérkt"} },
  { tense:"Present Perfect Continuous", topic:"prep", es:"Hemos estado trabajando en esta recomendación durante dos semanas.", en:"We have been working on this recommendation for two weeks.", enPh:"uí jav bin uérking on dis rekomendéishon for tú uíks.", verb:{base:"work",past:"worked",participle:"worked",meaning:"trabajar",basePh:"uérk",pastPh:"uérkt",participlePh:"uérkt"} },
  { tense:"Past Simple", topic:"prep", es:"Revisamos los costos después de la migración.", en:"We reviewed the costs after the migration.", enPh:"uí riviúd de kosts áfter de maigréishon.", verb:{base:"review",past:"reviewed",participle:"reviewed",meaning:"revisar",basePh:"riviú",pastPh:"riviúd",participlePh:"riviúd"} },
  { tense:"Past Continuous", topic:"prep", es:"Estábamos analizando los costos durante la reunión.", en:"We were analyzing the costs during the meeting.", enPh:"uí uer ánalaizing de kosts diúring de míting.", verb:{base:"analyze",past:"analyzed",participle:"analyzed",meaning:"analizar",basePh:"ánalaiz",pastPh:"ánalaizd",participlePh:"ánalaizd"} },
  { tense:"Past Perfect", topic:"prep", es:"Habíamos revisado el forecast antes de la reunión.", en:"We had reviewed the forecast before the meeting.", enPh:"uí jad riviúd de fórkast bifór de míting.", verb:{base:"review",past:"reviewed",participle:"reviewed",meaning:"revisar",basePh:"riviú",pastPh:"riviúd",participlePh:"riviúd"} },
  { tense:"Past Perfect Continuous", topic:"prep", es:"Habíamos estado trabajando en el análisis durante tres días antes de la reunión.", en:"We had been working on the analysis for three days before the meeting.", enPh:"uí jad bin uérking on di análasis for zrí déis bifór de míting.", verb:{base:"work",past:"worked",participle:"worked",meaning:"trabajar",basePh:"uérk",pastPh:"uérkt",participlePh:"uérkt"} },
  { tense:"Future Simple", topic:"prep", es:"Enviaremos el informe al cliente antes del viernes.", en:"We will send the report to the client by Friday.", enPh:"uí uil send de ripórt tu de kláient bai fráidei.", verb:{base:"send",past:"sent",participle:"sent",meaning:"enviar",basePh:"send",pastPh:"sent",participlePh:"sent"} },
  { tense:"Be Going To", topic:"prep", es:"Vamos a trabajar en el presupuesto con el equipo financiero.", en:"We are going to work on the budget with the finance team.", enPh:"uí ar góuing tu uérk on de bádyet uiz de fáinans tím.", verb:{base:"work",past:"worked",participle:"worked",meaning:"trabajar",basePh:"uérk",pastPh:"uérkt",participlePh:"uérkt"} },
  { tense:"Future Continuous", topic:"prep", es:"Estaremos trabajando con el cliente durante la migración.", en:"We will be working with the client during the migration.", enPh:"uí uil bi uérking uiz de kláient diúring de maigréishon.", verb:{base:"work",past:"worked",participle:"worked",meaning:"trabajar",basePh:"uérk",pastPh:"uérkt",participlePh:"uérkt"} },
  { tense:"Future Perfect", topic:"prep", es:"Habremos completado el análisis para el viernes.", en:"We will have completed the analysis by Friday.", enPh:"uí uil jav komplítid di análasis bai fráidei.", verb:{base:"complete",past:"completed",participle:"completed",meaning:"completar",basePh:"komplít",pastPh:"komplítid",participlePh:"komplítid"} },
  { tense:"Future Perfect Continuous", topic:"prep", es:"Para diciembre, habremos estado trabajando en la optimización durante seis meses.", en:"By December, we will have been working on the optimization for six months.", enPh:"bai disémber, uí uil jav bin uérking on di optimizéishon for siks manths.", verb:{base:"work",past:"worked",participle:"worked",meaning:"trabajar",basePh:"uérk",pastPh:"uérkt",participlePh:"uérkt"} },
];
...
function getPool() {
  ...
  return filter === "all" ? questions : filter === "finops" ? questions.filter(q => q.topic === "finops") : questions.filter(q => q.tense === filter);
}
